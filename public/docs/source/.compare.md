    ...
    "data": [
        {
            ...
            "manager": {
                ...
                "created_at": {
                    "date": "2019-02-28 10:48:21.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
                    "date": "2019-02-28 10:48:34.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "deleted_at": null
        ...
        },
        {
            ...
            "updated_at": {
                "date": "2019-02-28 10:48:54.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "deleted_at": null
...
curl -X POST "http://localhost/api/attributes" \
    ...
    -d '{"name":"2alDvyva8w3HFTEF","plus_minus":4}'
...
```json
{
    "data": {
        ...
        "name": "attributenamemKw3h",
        "plus_minus": null,
        "created_at": {
            "date": "2019-02-28 10:48:59.000000",
            "timezone_type": 3,
            "timezone": "UTC"
        },
        "updated_at": {
...
curl -X PUT "http://localhost/api/attributes/{attribute}" \
    -H "Content-Type: application/json" \
    -d '{"name":"pXKjT2XjhhR3r9Rs","plus_minus":14}'
...
curl -X POST "http://localhost/api/auth/register" \
    -H "Content-Type: application/json" \
    -d '{"email":"qubTsHT69OJRAwao","username":"0G3XpAEuvvsAxgZE","password":"cN4yCEjL9Ax2cdXk"}'
...
let body = {
    "email": "qubTsHT69OJRAwao",
    "username": "0G3XpAEuvvsAxgZE",
    "password": "cN4yCEjL9Ax2cdXk"
}
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvcmVnaXN0ZXIiLCJpYXQiOjE1NTEzNTA5MzQsImV4cCI6MTU1MTM1NDUzNCwibmJmIjoxNTUxMzUwOTM0LCJqdGkiOiJKWEw5MEMyTElPOVF0bjRJIiwic3ViIjo1MSwicHJ2IjoiODdlMGFmMWVmOWZkMTU4MTJmZGVjOTcxNTNhMTRlMGIwNDc1NDZhYSJ9.aqKbzHlql1q1P7bw0LZwI-BB67P4VEc0uet6cHwemiM",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
curl -X POST "http://localhost/api/auth/login" \
    -H "Content-Type: application/json" \
    -d '{"email":"pFRwDn92OdzRdVxT","password":"cjIStiK073zAKWYL"}'
...
let body = {
    "email": "pFRwDn92OdzRdVxT",
    "password": "cjIStiK073zAKWYL"
}
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvbG9naW4iLCJpYXQiOjE1NTEzNTA5NDEsImV4cCI6MTU1MTM1NDU0MSwibmJmIjoxNTUxMzUwOTQxLCJqdGkiOiJsTU9sQ283R1N1anY2d21PIiwic3ViIjo4LCJwcnYiOiI4N2UwYWYxZWY5ZmQxNTgxMmZkZWM5NzE1M2ExNGUwYjA0NzU0NmFhIn0.XjdHDfS4uWyNlNH3NlROxvIEnxmX68hVbC4_4dUSfMc",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvcmVmcmVzaCIsImlhdCI6MTU1MTM1MDkzOSwiZXhwIjoxNTUxMzU0NTM5LCJuYmYiOjE1NTEzNTA5MzksImp0aSI6IjF5MmhpR0FDMlA4UHpyaXciLCJzdWIiOjcsInBydiI6Ijg3ZTBhZjFlZjlmZDE1ODEyZmRlYzk3MTUzYTE0ZTBiMDQ3NTQ2YWEifQ.bnVjmzK1YRP1EMoImEsPBS0ur4eNAF55ryAS2r_QFUI",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
curl -X POST "http://localhost/api/admin/auth/login" \
    -H "Content-Type: application/json" \
    -d '{"email":"C59bQnjJ6kHhNSt1","password":"sFEPVWVXTWzfTees"}'
...
let body = {
    "email": "C59bQnjJ6kHhNSt1",
    "password": "sFEPVWVXTWzfTees"
}
    ...
    "data": [
        {
            ...
            "group": {
                ...
                "users": [
                    {
                        "id": 25,
                        "unique_id": "caHK6WV50r",
                        "name": null,
                        "username": "山田 香織",
                        "email": "zhirokawa@example.com",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-28 10:48:21.000000",
                    ...
                    {
                        "id": 29,
                        "unique_id": "RXj1biWE6r",
                        "name": null,
                        "username": "山田 知実",
                        "email": "momoko.nishinosono@example.com",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-28 10:48:21.000000",
                    ...
                    {
                        "id": 40,
                        "unique_id": "Y6FnY03rKA",
                        "name": null,
                        "username": "高橋 知実",
                        "email": "miki83@example.net",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-28 10:48:21.000000",
        ...
        },
        {
            ...
            "group": {
                ...
                "users": [],
                "created_at": {
                    "date": "2019-02-28 10:48:55.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
...
curl -X POST "http://localhost/api/default_settings" \
    -H "Content-Type: application/json" \
    -d '{"name":"VSMVeOtYAMV3eP3b","current_location_flag":true,"latitude":"WcarihLIl9C4FpSM","longitude":"VXC3kqP5zMtSkVO7","timer":10,"group_id":1}'
...
let body = {
    "name": "VSMVeOtYAMV3eP3b",
    "current_location_flag": true,
    "latitude": "WcarihLIl9C4FpSM",
    "longitude": "VXC3kqP5zMtSkVO7",
    "timer": 10,
    "group_id": 1
}
    ...
    "data": {
        ...
        "group": {
            ...
            "users": [
                ...
                {
                    "id": 44,
                    "unique_id": "HIqlfpypaF",
                    "name": null,
                    "username": "田中 直人",
                    "email": "kiriyama.akira@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-28 10:48:21.000000",
        ...
        "created_at": {
            "date": "2019-02-28 10:49:00.000000",
            "timezone_type": 3,
            "timezone": "UTC"
        },
        "updated_at": {
...
const url = new URL("http://localhost/api/default_settings/{default_setting}");
    ...
    let params = {
            "default_setting": "TEA0gAZaf9JB57VS",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
curl -X PUT "http://localhost/api/default_settings/{default_setting}" \
    -H "Content-Type: application/json" \
    -d '{"name":"on3H46K4TfaFHBCo","current_location_flag":true,"latitude":"Hq4EPRZJVW6mDPfe","longitude":"bym1mtl9WOxVBkGR","timer":20,"group_id":8}'
...
const url = new URL("http://localhost/api/default_settings/{default_setting}");
    ...
    let params = {
            "default_setting": "qKhmVtFurJICyFA6",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
let body = {
    "name": "on3H46K4TfaFHBCo",
    "current_location_flag": true,
    "latitude": "Hq4EPRZJVW6mDPfe",
    "longitude": "bym1mtl9WOxVBkGR",
    "timer": 20,
    "group_id": 8
}
...
const url = new URL("http://localhost/api/default_settings/{default_setting}");
    ...
    let params = {
            "default_setting": "Tbp0tSsibqGkF04o",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
    ...
    "data": [
        {
            ...
            "updated_at": {
                "date": "2019-02-28 10:48:56.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "deleted_at": null
        ...
        {
            "id": 10,
            "unique_id": "gDNiL6RrMA",
            "name": null,
            "username": "村山 美加子",
            "email": "rmiyazawa@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
        ...
        {
            "id": 28,
            "unique_id": "MfLJOdGJbb",
            "name": null,
            "username": "田中 裕樹",
            "email": "shota05@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
        ...
        {
            "id": 37,
            "unique_id": "Fg8ovtP5H9",
            "name": null,
            "username": "渚 知実",
            "email": "rwatanabe@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
...
```json
{
    "data": [
        {
            "id": 13,
            "unique_id": "wvexWuc2x6",
            "name": null,
            "username": "田中 晃",
            "email": "taichi.wakamatsu@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
                ...
                "plus_minus": 1317,
                "created_at": {
                    "date": "2019-02-28 10:48:23.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": 753,
                "created_at": {
                    "date": "2019-02-28 10:48:33.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 56,
            "unique_id": "tJYL8VQgrK",
            "name": null,
            "username": "aaaa",
            "email": "mFKb78T@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "permitted": 0,
            "attribute": null,
...
```json
{
    "data": [
        {
            "id": 14,
            "unique_id": "4w4R6teUYX",
            "name": null,
            "username": "宮沢 直樹",
            "email": "kyosuke.fujimoto@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
        ...
        {
            "id": 32,
            "unique_id": "Y203BU1mpi",
            "name": null,
            "username": "中島 くみ子",
            "email": "fsasada@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
        ...
        {
            "id": 35,
            "unique_id": "mSp2WIvlnv",
            "name": null,
            "username": "松本 美加子",
            "email": "manabu09@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
        ...
        {
            "id": 45,
            "unique_id": "isFTNkTkY2",
            "name": null,
            "username": "喜嶋 香織",
            "email": "dyamaguchi@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
...
```json
{
    "data": [
        {
            "id": 17,
            "unique_id": "kDCboiCprR",
            "name": null,
            "username": "田辺 英樹",
            "email": "haruka.hirokawa@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": null,
        ...
        {
            "id": 20,
            "unique_id": "plz1buLhkZ",
            "name": null,
            "username": "斉藤 知実",
            "email": "miki55@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 21,
            "unique_id": "cy5G6e48f5",
            "name": null,
            "username": "近藤 里佳",
            "email": "yui80@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 27,
            "unique_id": "cf50uUOEUo",
            "name": null,
            "username": "吉本 加奈",
            "email": "nanami88@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 30,
            "unique_id": "fz87j0PUsi",
            "name": null,
            "username": "坂本 里佳",
            "email": "satomi.saito@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 31,
            "unique_id": "Z1OxWEV58j",
            "name": null,
            "username": "宇野 里佳",
            "email": "vsuzuki@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 33,
            "unique_id": "NdXPzIoAsS",
            "name": null,
            "username": "村山 浩",
            "email": "shuhei.suzuki@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": null,
        ...
        {
            "id": 47,
            "unique_id": "BMdiSvvqy6",
            "name": null,
            "username": "原田 零",
            "email": "ishida.rei@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
...
```json
{
    "data": [
        ...
        {
            "id": 9,
            "unique_id": "DTNqW8fOWp",
            "name": null,
            "username": "佐々木 和也",
            "email": "sato.mikako@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -744,
                "created_at": {
                    "date": "2019-02-28 10:48:22.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 11,
            "unique_id": "2f6a1pI6tz",
            "name": null,
            "username": "浜田 さゆり",
            "email": "takuma.yamagishi@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": 2082,
                "created_at": {
                    "date": "2019-02-28 10:48:25.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -1926,
                "created_at": {
                    "date": "2019-02-28 10:48:26.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -641,
                "created_at": {
                    "date": "2019-02-28 10:48:27.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -2572,
                "created_at": {
                    "date": "2019-02-28 10:48:28.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": 1179,
                "created_at": {
                    "date": "2019-02-28 10:48:29.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 38,
            "unique_id": "Xx0fl3yDYg",
            "name": null,
            "username": "渡辺 桃子",
            "email": "nakamura.kazuya@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": -875,
                "created_at": {
                    "date": "2019-02-28 10:48:30.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 42,
            "unique_id": "u52Iwp5xsH",
            "name": null,
            "username": "工藤 七夏",
            "email": "maaya57@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": 1027,
                "created_at": {
                    "date": "2019-02-28 10:48:31.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 43,
            "unique_id": "dHeWO1K1O8",
            "name": null,
            "username": "伊藤 康弘",
            "email": "kenichi94@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": -771,
                "created_at": {
                    "date": "2019-02-28 10:48:32.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
    ...
    "data": [
        {
            ...
            "attribute": {
                ...
                "plus_minus": 2328,
                "created_at": {
                    "date": "2019-02-28 10:48:24.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 22,
            "unique_id": "ov4fSzoiXX",
            "name": null,
            "username": "松本 学",
            "email": "qhirokawa@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 24,
            "unique_id": "lamHA5eona",
            "name": null,
            "username": "中島 太郎",
            "email": "kobayashi.jun@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 36,
            "unique_id": "nfUl0bUQpH",
            "name": null,
            "username": "中津川 裕樹",
            "email": "pkudo@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 39,
            "unique_id": "yizeeLJ49O",
            "name": null,
            "username": "井上 零",
            "email": "maaya67@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
...
curl -X POST "http://localhost/api/device_token" \
    -H "Content-Type: application/json" \
    -d '{"device_token":"ClcQqcfIGBIbWqeW"}'
...
```json
{
    "data": {
        ...
        "device_token": "newTokenBBIiFXS1UvZnkk1rwhp7",
        "created_at": {
            "date": "2019-02-28 10:48:59.000000",
            "timezone_type": 3,
            "timezone": "UTC"
...
const url = new URL("http://localhost/api/groups/{group}/users/{user}");
    ...
    let params = {
            "group": "aHJ7Cz20tvFhAt8b",
            "user": "2sPhlxN1dfqjRGww",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/groups/{group}/users/{user}");
    ...
    let params = {
            "group": "LWdav57U1z4r7jA9",
            "user": "DxbcPl16Qq2WjVn3",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
    ...
    "data": [
        {
            ...
            "budget": 14894,
            "actual": 11691,
            "start_time": "2019-02-23 10:48:21",
            "end_time": null,
            ...
            "users": [
                ...
                {
                    "id": 16,
                    "unique_id": "cHagzDQZ87",
                    "name": null,
                    "username": "伊藤 くみ子",
                    "email": "yui37@example.com",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "deny",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 11694,
            "actual": 43921,
            "start_time": "2019-02-18 10:48:21",
            "end_time": "2019-02-23 10:48:21",
            "unit_rounding_budget": "100",
            "unit_rounding_actual": "100",
            "manager": {
                "id": 8,
            ...
            "users": [
                ...
                {
                    "id": 19,
                    "unique_id": "KDLkcxomdI",
                    "name": null,
                    "username": "田中 陽子",
                    "email": "mai66@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "allow",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 20149,
            "actual": 18739,
            "start_time": "2019-02-23 10:48:22",
            "end_time": null,
            "unit_rounding_budget": "100",
            "unit_rounding_actual": "100",
            "manager": {
        ...
        },
        {
            ...
            "budget": 14081,
            "actual": 32606,
            "start_time": "2019-02-23 10:48:25",
            "end_time": "2019-03-10 10:48:25",
            "unit_rounding_budget": "100",
            "unit_rounding_actual": "100",
            "manager": {
                "id": 20,
        ...
        },
        {
            ...
            "budget": 26157,
            "actual": 38119,
            "start_time": "2019-03-05 10:48:27",
            "end_time": "2019-03-10 10:48:27",
            "unit_rounding_budget": "100",
            "unit_rounding_actual": "100",
            "manager": {
                "id": 26,
            ...
            "users": [
                ...
                {
                    "id": 46,
                    "unique_id": "nF2h8ahMM1",
                    "name": null,
                    "username": "松本 花子",
                    "email": "mkobayashi@example.org",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "deny",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget":
000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 55,
            "unique_id": "UlBifts1HT",
            "name": null,
            "username": "aaaa",
            "email": "AMoTfT@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-28 10:48:55.000000",
        ...
        {
            "id": 57,
            "unique_id": "Mv5gSg68e9",
            "name": null,
            "username": "aaaa",
            "email": "rZxAb97t@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-28 10:48:55.000000",
        ...
        {
            "id": 61,
            "unique_id": "XPrDYLYJw1",
            "name": null,
            "username": "aaaa",
            "email": "Sd2TQo@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-28 10:49:00.000000",
        ...
        {
            "id": 62,
            "unique_id": "YnwuvnbZeD",
            "name": null,
            "username": "aaaa",
            "email": "mTKeGVg@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-28 10:49:00.000000",
        ...
        {
            "id": 63,
            "unique_id": "Zze5376Zy3",
            "name": null,
            "username": "aaaa",
            "email": "h9W7sXOD@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-28 10:49:00.000000",
...
curl -X POST "http://localhost/api/sessions/{session}/users" \
    -H "Content-Type: application/json" \
    -d '{"user_id":"3H8Sh36V4muKPNHd","join_status":"zFqdLwHpl61J5ida","paid":13,"budget":9,"budget_actual":5}'
...
let body = {
    "user_id": "3H8Sh36V4muKPNHd",
    "join_status": "zFqdLwHpl61J5ida",
    "paid": 13,
    "budget": 9,
    "budget_actual": 5
}
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "tYFgZIoRTg9aKCJY",
            "user": "UHQCzlf6A3lf7ULz",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
curl -X PUT "http://localhost/api/sessions/{session}/users/{user}" \
    -H "Content-Type: application/json" \
    -d '{"join_status":8,"paid":3,"plus_minus":12,"attribute_name":"jC8YjWP32KjsEIMC","budget":18,"budget_actual":6}'
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "hvrW46gKzQoDRA5p",
            "user": "IKU3a9q5IASxd0WB",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
let body = {
    ...
    "paid": 3,
    "plus_minus": 12,
    "attribute_name": "jC8YjWP32KjsEIMC",
    "budget": 18,
    "budget_actual": 6
}
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "HUhBJAMT1yTWqpBA",
            "user": "gz09l2PpHDym2itY",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}/switch_paid");
    ...
    let params = {
            "session": "i5XZceHl34ZJI1JX",
            "user": "3AVKDeyUTRMOpqky",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/sessions/{session}/groups/{group}");
    ...
    let params = {
            "session": "iLwMPTNcGfrj3lr1",
            "group": "GbmCZaokKJysHmk0",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
```json
{
    "data": [
        ...
        },
        {
            ...
            "budget": 20369,
            "actual": 29616,
            "start_time": "2019-03-05 10:48:21",
            "end_time": "2019-03-10 10:48:21",
            "unit_rounding_budget": "100",
            "unit_rounding_actual": "100",
            "manager": {
                "id": 7,
        ...
        },
        {
            ...
            "users": [],
            "created_at": {
                "date": "2019-02-28 10:48:57.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
...
curl -X POST "http://localhost/api/sessions" \
    -H "Content-Type: application/json" \
    -d '{"name":"EwCf4Cryx9O2DVTg","shop_id":"GdsM3hwpk8vDJnw6","budget":9,"actual":7,"unit_rounding_budget":19,"unit_rounding_actual":17,"start_time":"q9ofv492IGp57bzt","end_time":"WNpssln6qUOZ0DA0"}'
...
let body = {
    "name": "EwCf4Cryx9O2DVTg",
    "shop_id": "GdsM3hwpk8vDJnw6",
    "budget": 9,
    "actual": 7,
    "unit_rounding_budget": 19,
    "unit_rounding_actual": 17,
    "start_time": "q9ofv492IGp57bzt",
    "end_time": "WNpssln6qUOZ0DA0"
}
...
curl -X PUT "http://localhost/api/sessions/{session}" \
    -H "Content-Type: application/json" \
    -d '{"name":"IhT5ioPGAzA0xCAo","shop_id":18,"budget":9,"actual":14,"unit_rounding_budget":4,"unit_rounding_actual":7,"start_time":"37SsP7aTODyYXmUR","end_time":"1MtDTqQpfg1ildLQ"}'
...
let body = {
    "name": "IhT5ioPGAzA0xCAo",
    "shop_id": 18,
    "budget": 9,
    "actual": 14,
    "unit_rounding_budget": 4,
    "unit_rounding_actual": 7,
    "start_time": "37SsP7aTODyYXmUR",
    "end_time": "1MtDTqQpfg1ildLQ"
}
