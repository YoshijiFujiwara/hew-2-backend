...
```bash
curl -X POST "http://localhost/api/auth/register"     -d "email"="uuKyMjO8TUMM4hFz" \
    -d "username"="cESTmznpUrhVFBoA" \
    -d "password"="nO9Fzu6ZY9A9ecDT" 
```
...
let body = JSON.stringify({
    "email": "uuKyMjO8TUMM4hFz",
    "username": "cESTmznpUrhVFBoA",
    "password": "nO9Fzu6ZY9A9ecDT",
})
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvcmVnaXN0ZXIiLCJpYXQiOjE1NDk3MTg2ODgsImV4cCI6MTU0OTcyMjI4OCwibmJmIjoxNTQ5NzE4Njg4LCJqdGkiOiJXMTV4cXo4WU55cUxNWUFJIiwic3ViIjo5MSwicHJ2IjoiODdlMGFmMWVmOWZkMTU4MTJmZGVjOTcxNTNhMTRlMGIwNDc1NDZhYSJ9.nWQ1QlxUnFSXuCHF9j3reahjHdNtFG9RlyN9jEEadyM",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
```bash
curl -X POST "http://localhost/api/auth/login"     -d "email"="U1JfdbxePT5t600P" \
    -d "password"="YqeSdX12dR6lIPH0" 
```
...
let body = JSON.stringify({
    "email": "U1JfdbxePT5t600P",
    "password": "YqeSdX12dR6lIPH0",
})
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvbG9naW4iLCJpYXQiOjE1NDk3MTg2ODksImV4cCI6MTU0OTcyMjI4OSwibmJmIjoxNTQ5NzE4Njg5LCJqdGkiOiJkdDU1Mmc1WUlaSFNXRlNxIiwic3ViIjoyLCJwcnYiOiI4N2UwYWYxZWY5ZmQxNTgxMmZkZWM5NzE1M2ExNGUwYjA0NzU0NmFhIn0.nvWbxUAv56U4ASLD525eFYd-PMG6htidA8SeD0JP8kY",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvcmVmcmVzaCIsImlhdCI6MTU0OTcxODY4OCwiZXhwIjoxNTQ5NzIyMjg4LCJuYmYiOjE1NDk3MTg2ODgsImp0aSI6Ikh6bk9TR05jMEFQSkNIMGgiLCJzdWIiOjEsInBydiI6Ijg3ZTBhZjFlZjlmZDE1ODEyZmRlYzk3MTUzYTE0ZTBiMDQ3NTQ2YWEifQ.ALZBPO04L2qraXB3d4QCOiQ95lbkrNQMi9DRQcdvFZs",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
{
    "id": 1,
    "unique_id": "NTho4NXHPw",
    "username": "テスト太郎",
    "email": "testuser@example.com",
    "email_verified_at": "2019-02-09 13:23:14",
    "created_at": "2019-02-09 13:23:16",
    "updated_at": "2019-02-09 13:23:33"
}
```
...
```json
{
    "data": [
        {
            "id": 3,
            "unique_id": "QMA0dpVhj6",
            "username": "津田 直樹",
            "email": "youichi27@example.org",
            "permitted": 1,
            "attribute_id": 3,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 12,
            "unique_id": "NFTGjNS7o5",
            "username": "加納 直人",
            "email": "kkanou@example.com",
            "permitted": 1,
            "attribute_id": 5,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
        ...
        {
            "id": 27,
            "unique_id": "n2YGuFnPUm",
            "username": "工藤 真綾",
            "email": "pyoshida@example.com",
            "permitted": 1,
            "attribute_id": 1,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
        ...
        {
            "id": 34,
            "unique_id": "BId3T81vTo",
            "username": "佐藤 晃",
            "email": "sayuri.murayama@example.net",
            "permitted": 1,
            "attribute_id": 2,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
        ...
        {
            "id": 38,
            "unique_id": "TFYuXK7Wg1",
            "username": "工藤 零",
            "email": "koizumi.nanami@example.net",
            "permitted": 1,
            "attribute_id": 1,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
...
```bash
curl -X POST "http://localhost/api/friends"     -d "email"="MfA5gLMbftQXB9Po" 
```
...
```json
{
    ...
    "updated_at": {
        "date": "2019-02-09 13:23:33.000000",
        "timezone_type": 3,
        "timezone": "UTC"
    }
}
    ...
    "data": [
        {
            ...
            "updated_at": {
                "date": "2019-02-09 13:24:26.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            }
        },
        {
            "id": 18,
            "unique_id": "TKTax93dnc",
            "username": "佐々木 加奈",
            "email": "tsuda.mikako@example.net",
            "permitted": 0,
            "attribute_id": 2,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
        ...
        {
            "id": 24,
            "unique_id": "TMhldthIC4",
            "username": "山本 学",
            "email": "kaori57@example.net",
            "permitted": 0,
            "attribute_id": 3,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
        ...
        {
            "id": 29,
            "unique_id": "TaiNb5at7X",
            "username": "山口 知実",
            "email": "osamu17@example.com",
            "permitted": 0,
            "attribute_id": 4,
            "created_at": {
                "date": "2019-02-09 13:23:16.000000",
...
```json
{
    "data": [
        {
            "id": 94,
            "unique_id": "AksOnKgTxG",
            "username": "testuser3",
            "email": "newfriend@newfriend.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:48.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
...
```json
{
    "data": [
        {
            "id": 55,
            "unique_id": "EVNnqV6XWD",
            "username": "aaaa",
            "email": "QVC6d@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:20.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 57,
            "unique_id": "mghLVqJs97",
            "username": "aaaa",
            "email": "XwppeDB@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:20.000000",
        ...
        {
            "id": 63,
            "unique_id": "ONC9p4HY9j",
            "username": "aaaa",
            "email": "DKlOj@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:22.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 65,
            "unique_id": "VM8x0qOMIr",
            "username": "aaaa",
            "email": "SI3h1J1@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:22.000000",
        ...
        {
            "id": 71,
            "unique_id": "HTAxo3QuBK",
            "username": "aaaa",
            "email": "H5ijI@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:24.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 73,
            "unique_id": "p8kKhnTFbY",
            "username": "aaaa",
            "email": "VB31e4V@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:24.000000",
        ...
        {
            "id": 81,
            "unique_id": "WTwu09KV0L",
            "username": "aaaa",
            "email": "xhuorDv@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:26.000000",
        ...
        {
            "id": 87,
            "unique_id": "Zqae9jsmWI",
            "username": "aaaa",
            "email": "2X09r@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:41.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 89,
            "unique_id": "WJxVe6RMci",
            "username": "aaaa",
            "email": "mkYwqfe@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:41.000000",
        ...
        {
            "id": 95,
            "unique_id": "rfZbX1K66r",
            "username": "aaaa",
            "email": "Co5jX@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:49.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        {
            "id": 97,
            "unique_id": "nIwqoUKdoP",
            "username": "aaaa",
            "email": "F8JBcw5@new.com",
            "permitted": null,
            "attribute_id": null,
            "created_at": {
                "date": "2019-02-09 13:24:49.000000",
...
```bash
curl -X POST "http://localhost/api/friends/permit"     -d "user_id"="1" 
```
    ...
    "data": [
        {
            ...
            "name": "newGroupedtu5lMF",
            "users": [
                {
                    "id": 11,
                    "unique_id": "DsgV00h9Hw",
                    "username": "青田 淳",
            ...
            "created_at": {
                "date": "2019-02-09 13:23:17.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "users": [
                {
                    "id": 10,
                    "unique_id": "hSL0b464fN",
                    "username": "山岸 あすか",
                    "email": "ktakahashi@example.com",
                    "created_at": {
                        "date": "2019-02-09 13:23:16.000000",
                        "timezone_type": 3,
                        "timezone": "UTC"
        ...
        },
        {
            ...
            "users": [
                {
                    "id": 33,
                    "unique_id": "tdaYTCpXrH",
                    "username": "山田 涼平",
                    "email": "tomoya60@example.org",
                    "created_at": {
                        "date": "2019-02-09 13:23:16.000000",
                        "timezone_type": 3,
                        "timezone": "UTC"
            ...
            "created_at": {
                "date": "2019-02-09 13:24:23.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "created_at": {
                "date": "2019-02-09 13:24:25.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "users": [],
            "created_at": {
                "date": "2019-02-09 13:24:42.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
...
```bash
curl -X POST "http://localhost/api/groups"     -d "name"="DHkInYkforga8ps4" 
```
...
```bash
curl -X PUT "http://localhost/api/groups/{group}"     -d "name"="lLX84RoTgx5D95YB" 
```
...
const url = new URL("http://localhost/api/groups/{group}/users/{user}");
    ...
    let params = {
            "group": "YR9c0Bm5Wu4a7oVg",
            "user": "ES7QbX6W0a0uUIBd",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/groups/{group}/users/{user}");
    ...
    let params = {
            "group": "XmSauABYQAkjDJEg",
            "user": "yYqwFKtRi3ntY7La",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
    ...
    "data": [
        {
            ...
            "budget": 9542,
            "actual": 31890,
            "start_time": "1978-02-20 01:04:37",
            "end_time": null,
            "manager": {
                "id": 1,
                "unique_id": "NTho4NXHPw",
            ...
            "users": [
                {
                    "id": 9,
                    "unique_id": "2wBDFebrfc",
                    "username": "松本 さゆり",
                    "email": "kobayashi.kumiko@example.net",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 48,
                    "unique_id": "M7275BVN2g",
                    "username": "青山 くみ子",
                    "email": "ctanabe@example.org",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 13096,
            "actual": 39394,
            "start_time": "2019-01-10 05:20:06",
            "end_time": null,
            "manager": {
                "id": 1,
                "unique_id": "NTho4NXHPw",
        ...
        },
        {
            ...
            "budget": 5195,
            "actual": 29763,
            "start_time": "1971-08-07 12:02:17",
            "end_time": null,
            "manager": {
                "id": 1,
                "unique_id": "NTho4NXHPw",
        ...
        },
        {
            ...
            "updated_at": {
                "date": "2019-02-09 13:24:27.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            }
        },
...
```bash
curl -X POST "http://localhost/api/sessions"     -d "name"="r1rMJQqZnYsh1xLO" \
    -d "shop_id"="7" \
    -d "budget"="13" \
    -d "actual"="20" \
    -d "start_time"="4Bnmm3dSUmnRqwFL" \
    -d "end_time"="KclEzogxtJYZ1T02" 
```
...
let body = JSON.stringify({
    "name": "r1rMJQqZnYsh1xLO",
    "shop_id": "7",
    "budget": "13",
    "actual": "20",
    "start_time": "4Bnmm3dSUmnRqwFL",
    "end_time": "KclEzogxtJYZ1T02",
})
...
```bash
curl -X PUT "http://localhost/api/sessions/{session}"     -d "name"="8FZCYVpdkGqKV9X3" \
    -d "shop_id"="3" \
    -d "budget"="9" \
    -d "actual"="1" \
    -d "start_time"="v08G0zs3BIpBrunb" \
    -d "end_time"="NFEkJ7RZhXZG01KG" 
```
...
let body = JSON.stringify({
    "name": "8FZCYVpdkGqKV9X3",
    "shop_id": "3",
    "budget": "9",
    "actual": "1",
    "start_time": "v08G0zs3BIpBrunb",
    "end_time": "NFEkJ7RZhXZG01KG",
})
...
```bash
curl -X POST "http://localhost/api/sessions/{session}/users"     -d "user_id"="lJ7NZb5W0cW71MD4" \
    -d "join_status"="Bii17K6uJmfe41vP" \
    -d "paid"="2" \
    -d "plus_minus"="1" \
    -d "ratio"="y0suYLH38mW6Bk1L" 
```
...
let body = JSON.stringify({
    "user_id": "lJ7NZb5W0cW71MD4",
    "join_status": "Bii17K6uJmfe41vP",
    "paid": "2",
    "plus_minus": "1",
    "ratio": "y0suYLH38mW6Bk1L",
})
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "TDMpQd9EPZYaHWhc",
            "user": "K66ehdJBHstpoYjJ",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT "http://localhost/api/sessions/{session}/users/{user}"     -d "user_id"="iGdgjpvaBhsVpVr5" \
    -d "join_status"="hSVMeIDlznYZZqjW" \
    -d "paid"="1" \
    -d "plus_minus"="11" \
    -d "ratio"="Hymy57Mm8OFjE4dG" 
```
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "NZIDt14SRe9tlamr",
            "user": "KBuFTkZCt9b0tu68",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
let body = JSON.stringify({
    "user_id": "iGdgjpvaBhsVpVr5",
    "join_status": "hSVMeIDlznYZZqjW",
    "paid": "1",
    "plus_minus": "11",
    "ratio": "Hymy57Mm8OFjE4dG",
})
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "Y2cx6ryKFDJ4qCnJ",
            "user": "05pdtYxYGqwTd41t",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
```json
{
    "data": [
        ...
        },
        {
            ...
            "updated_at": {
                "date": "2019-02-09 13:24:19.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            }
        },
...
```bash
curl -X POST "http://localhost/api/attributes"     -d "name"="yoDJ4JzYrBaMBjnV" \
    -d "plus_minus"="17" \
    -d "ratio"="37993.433585" 
```
...
```bash
curl -X PUT "http://localhost/api/attributes/{attribute}"     -d "name"="kCbZEMx54Dkcivzz" \
    -d "plus_minus"="6" \
    -d "ratio"="1180.387" 
```
    ...
    "data": [
        {
            ...
            "budget": 12332,
            "actual": 44820,
            "start_time": "1978-11-25 00:19:42",
            "end_time": null,
            "manager": {
                "id": 12,
                "unique_id": "NFTGjNS7o5",
            ...
            "users": [
                ...
                {
                    "id": 17,
                    "unique_id": "T4t8dqpPFa",
                    "username": "中島 くみ子",
                    "email": "nanami.ogaki@example.net",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 41,
                    "unique_id": "dWqaJfQ7U6",
                    "username": "宮沢 真綾",
                    "email": "kaori.kimura@example.com",
                    "join_status": "allow",
                    "paid": 1,
                    "plus_minus": null,
                    "ratio": null,
            ...
            "created_at": {
                "date": "2019-02-09 13:23:20.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "budget": 26160,
            "actual": 22946,
            "start_time": "2006-07-31 23:34:23",
            "end_time": null,
            "manager": {
                "id": 12,
                "unique_id": "NFTGjNS7o5",
        ...
        },
        {
            ...
            "budget": 21110,
            "actual": 27032,
            "start_time": "1988-05-15 22:17:23",
            "end_time": null,
            "manager": {
                "id": 25,
                "unique_id": "sbrnP3dR5H",
                "username": "松本 晃",
                "email": "naoki08@example.com",
                "created_at": {
                    "date": "2019-02-09 13:23:16.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
            ...
            "users": [
                ...
                {
                    "id": 14,
                    "unique_id": "fk8XKgxyQ2",
                    "username": "佐藤 浩",
                    "email": "momoko.yamamoto@example.com",
                    "join_status": "allow",
                    "paid": 0,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 20,
                    "unique_id": "VkqtE2u0Dy",
                    "username": "加藤 裕太",
                    "email": "rei.ito@example.org",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 43,
                    "unique_id": "fXlNsMOjWA",
                    "username": "近藤 淳",
                    "email": "maaya68@example.net",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
            ...
            "created_at": {
                "date": "2019-02-09 13:23:25.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "budget": 5231,
            "actual": 9442,
            "start_time": "1974-02-10 17:38:11",
            "end_time": null,
            "manager": {
                "id": 25,
                "unique_id": "sbrnP3dR5H",
            ...
            "users": [
                ...
                {
                    "id": 4,
                    "unique_id": "uqi9s040xN",
                    "username": "中津川 涼平",
                    "email": "csasada@example.org",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 8050,
            "actual": 44152,
            "start_time": "1972-08-26 02:45:03",
            "end_time": null,
            "manager": {
                "id": 29,
                "unique_id": "TaiNb5at7X",
            ...
            "users": [
                ...
                {
                    "id": 22,
                    "unique_id": "6g76x2eXJ7",
                    "username": "井上 結衣",
                    "email": "nanami.yamamoto@example.org",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 31,
                    "unique_id": "PIXSavVewG",
                    "username": "津田 知実",
                    "email": "lnakajima@example.org",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
            ...
            "created_at": {
                "date": "2019-02-09 13:23:26.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "budget": 5524,
            "actual": 48714,
            "start_time": "2015-05-17 03:33:39",
            "end_time": null,
            "manager": {
                "id": 34,
                "unique_id": "BId3T81vTo",
            ...
            "users": [
                ...
                {
                    "id": 7,
                    "unique_id": "FHWy6nBtTg",
                    "username": "加納 結衣",
                    "email": "hanako.yoshida@example.com",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 28,
                    "unique_id": "HcmI3W5Zvf",
                    "username": "鈴木 直子",
                    "email": "takahashi.kyosuke@example.org",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 44,
                    "unique_id": "fa39FnwqQj",
                    "username": "木村 結衣",
                    "email": "yumiko41@example.org",
                    "join_status": "allow",
                    "paid": 1,
                    "plus_minus": null,
                    "ratio": null,
            ...
            "created_at": {
                "date": "2019-02-09 13:23:28.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "budget": 12467,
            "actual": 44017,
            "start_time": "1971-10-21 02:55:50",
            "end_time": null,
            "manager": {
                "id": 34,
                "unique_id": "BId3T81vTo",
        ...
        },
        {
            ...
            "budget": 29995,
            "actual": 31286,
            "start_time": "1983-09-06 01:19:34",
            "end_time": null,
            "manager": {
                "id": 35,
                "unique_id": "MfACbByaFq",
                "username": "杉山 舞",
                "email": "yamamoto.miki@example.com",
                "created_at": {
                    "date": "2019-02-09 13:23:16.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
            ...
            "users": [
                ...
                {
                    "id": 23,
                    "unique_id": "SLJzfWi1pN",
                    "username": "山口 聡太郎",
                    "email": "atsushi.sasaki@example.com",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 42,
                    "unique_id": "AniUlojFIE",
                    "username": "若松 京助",
                    "email": "miki27@example.org",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 24835,
            "actual": 24880,
            "start_time": "1996-04-05 23:01:04",
            "end_time": null,
            "manager": {
                "id": 35,
                "unique_id": "MfACbByaFq",
            ...
            "users": [
                ...
                {
                    "id": 6,
                    "unique_id": "0se9f9jmHc",
                    "username": "渡辺 さゆり",
                    "email": "youichi.ekoda@example.com",
                    "join_status": "allow",
                    "paid": 0,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 19,
                    "unique_id": "nd67ekRpMt",
                    "username": "坂本 桃子",
                    "email": "kobayashi.ryohei@example.org",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 45,
                    "unique_id": "v3k7iT0x0Q",
                    "username": "三宅 あすか",
                    "email": "tomoya42@example.net",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 10535,
            "actual": 37945,
            "start_time": "2006-03-16 01:55:16",
            "end_time": null,
            "manager": {
                "id": 35,
                "unique_id": "MfACbByaFq",
        ...
        },
        {
            ...
            "budget": 21896,
            "actual": 2526,
            "start_time": "1978-01-27 19:40:52",
            "end_time": null,
            "manager": {
                "id": 35,
                "unique_id": "MfACbByaFq",
            ...
            "users": [
                ...
                {
                    "id": 8,
                    "unique_id": "xZn2OwrECF",
                    "username": "田辺 直人",
                    "email": "fnakamura@example.com",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 26808,
            "actual": 25968,
            "start_time": "1995-10-12 01:01:13",
            "end_time": null,
            "manager": {
                "id": 49,
                "unique_id": "IGQwaKP54K",
                "username": "近藤 晃",
                "email": "onakamura@example.org",
                "created_at": {
                    "date": "2019-02-09 13:23:16.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
            ...
            "users": [
                ...
                {
                    "id": 21,
                    "unique_id": "STfJnlbTWY",
                    "username": "田辺 翔太",
                    "email": "jhamada@example.com",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
                ...
                {
                    "id": 39,
                    "unique_id": "bz2Z0tuteP",
                    "username": "若松 和也",
                    "email": "koizumi.rika@example.net",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 11829,
            "actual": 33879,
            "start_time": "2018-09-18 08:42:52",
            "end_time": null,
            "manager": {
                "id": 49,
                "unique_id": "IGQwaKP54K",
            ...
            "users": [
                ...
                {
                    "id": 47,
                    "unique_id": "fB6qXsq39H",
                    "username": "藤本 幹",
                    "email": "wsugiyama@example.com",
                    "join_status": "wait",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
        ...
        },
        {
            ...
            "budget": 10543,
            "actual": 6548,
            "start_time": "1981-11-26 23:27:53",
            "end_time": null,
            "manager": {
                "id": 49,
                "unique_id": "IGQwaKP54K",
            ...
            "users": [
                ...
                {
                    "id": 16,
                    "unique_id": "xG9Zovzq05",
                    "username": "渚 零",
                    "email": "fujimoto.yui@example.com",
                    "join_status": "deny",
                    "paid": null,
                    "plus_minus": null,
                    "ratio": null,
...
```bash
curl -X PUT "http://localhost/api/profile/update"     -d "unique_id"="XJdN5SfSzgOhDHOJ" \
    -d "username"="97pxy4YkF9FeiJR3" \
    -d "password"="5f7Ad4vYyLPAP4h2" 
```
...
let body = JSON.stringify({
    "unique_id": "XJdN5SfSzgOhDHOJ",
    "username": "97pxy4YkF9FeiJR3",
    "password": "5f7Ad4vYyLPAP4h2",
})
