    ...
    "data": [
        {
            ...
            "manager": {
                ...
                "created_at": {
                    "date": "2019-02-27 15:16:59.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
                    "date": "2019-02-27 15:17:22.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "deleted_at": null
            ...
            "plus_minus": 1859,
            "created_at": {
                "date": "2019-02-27 15:17:00.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
...
curl -X POST "http://localhost/api/attributes" \
    ...
    -d '{"name":"bdcVzCsxmDRKgoqs","plus_minus":13}'
...
```json
{
    "data": {
        ...
        "name": "attributenamej4iUO",
        "plus_minus": null,
        "created_at": {
            "date": "2019-02-27 15:18:21.000000",
            "timezone_type": 3,
            "timezone": "UTC"
        },
        "updated_at": {
...
curl -X PUT "http://localhost/api/attributes/{attribute}" \
    -H "Content-Type: application/json" \
    -d '{"name":"jLg3qMZqKzN20tST","plus_minus":16}'
...
curl -X POST "http://localhost/api/auth/register" \
    -H "Content-Type: application/json" \
    -d '{"email":"EuO987x2zTeN2Cwn","username":"IRs5Q56VdpH5sqVh","password":"eWvCG1z6FuFeDYJN"}'
...
let body = {
    "email": "EuO987x2zTeN2Cwn",
    "username": "IRs5Q56VdpH5sqVh",
    "password": "eWvCG1z6FuFeDYJN"
}
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvcmVnaXN0ZXIiLCJpYXQiOjE1NTEyODA3MDIsImV4cCI6MTU1MTI4NDMwMiwibmJmIjoxNTUxMjgwNzAyLCJqdGkiOiJTS0hrWkxQOXd2NW9xMUw0Iiwic3ViIjo1MSwicHJ2IjoiODdlMGFmMWVmOWZkMTU4MTJmZGVjOTcxNTNhMTRlMGIwNDc1NDZhYSJ9.upFMbs7MFOoS7GuKVEZK8D1ijdtvFpqlIuDmpgmoc6U",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
curl -X POST "http://localhost/api/auth/login" \
    -H "Content-Type: application/json" \
    -d '{"email":"68lksDo8kbdaXs0u","password":"SX6byDTEsrbp6xsS"}'
...
let body = {
    "email": "68lksDo8kbdaXs0u",
    "password": "SX6byDTEsrbp6xsS"
}
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvbG9naW4iLCJpYXQiOjE1NTEyODA3MDQsImV4cCI6MTU1MTI4NDMwNCwibmJmIjoxNTUxMjgwNzA0LCJqdGkiOiJ4UGZWb2FNVmNSZTNNdWJ3Iiwic3ViIjoyLCJwcnYiOiI4N2UwYWYxZWY5ZmQxNTgxMmZkZWM5NzE1M2ExNGUwYjA0NzU0NmFhIn0.zIvmaX1z-7DK0gmB-G4uwvy-y9LwDXfthCFObvuyxo0",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
```json
{
    "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2FwaVwvYXV0aFwvcmVmcmVzaCIsImlhdCI6MTU1MTI4MDcwMiwiZXhwIjoxNTUxMjg0MzAyLCJuYmYiOjE1NTEyODA3MDIsImp0aSI6ImQyS1pLaWN5dEdqdndDOUQiLCJzdWIiOjEsInBydiI6Ijg3ZTBhZjFlZjlmZDE1ODEyZmRlYzk3MTUzYTE0ZTBiMDQ3NTQ2YWEifQ.4b2E8mTvcSTIyQOPreyVhB2J3piFay4Ts2SOrH2eBEs",
    "token_type": "bearer",
    "expires_in": 3600
}
```
...
curl -X POST "http://localhost/api/admin/auth/login" \
    -H "Content-Type: application/json" \
    -d '{"email":"8TFEyTV2ukwZnY3J","password":"zK3O5Lxp9hhe0rlG"}'
...
let body = {
    "email": "8TFEyTV2ukwZnY3J",
    "password": "zK3O5Lxp9hhe0rlG"
}
    ...
    "data": [
        {
            ...
            "group": {
                ...
                "users": [
                    {
                        "id": 2,
                        "unique_id": "35uJuuHIvd",
                        "name": null,
                        "username": "中島 直樹",
                        "email": "takuma.uno@example.com",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-27 15:16:59.000000",
                    ...
                    {
                        "id": 5,
                        "unique_id": "BBFBD4D37i",
                        "name": null,
                        "username": "木村 太郎",
                        "email": "vsuzuki@example.net",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-27 15:16:59.000000",
                    ...
                    {
                        "id": 6,
                        "unique_id": "CFZMebzj9N",
                        "name": null,
                        "username": "鈴木 聡太郎",
                        "email": "akira59@example.net",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-27 15:16:59.000000",
                    ...
                    {
                        "id": 20,
                        "unique_id": "WMjCRSAnG3",
                        "name": null,
                        "username": "佐藤 里佳",
                        "email": "osamu.nakatsugawa@example.com",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-27 15:17:00.000000",
                    ...
                    {
                        "id": 22,
                        "unique_id": "09R033UkPb",
                        "name": null,
                        "username": "原田 亮介",
                        "email": "kaori.miyazawa@example.org",
                        "unique_id_search_flag": 1,
                        "username_search_flag": 1,
                        "created_at": {
                            "date": "2019-02-27 15:17:00.000000",
...
curl -X POST "http://localhost/api/default_settings" \
    -H "Content-Type: application/json" \
    -d '{"name":"r9XxdKM7SdWQQZDy","current_location_flag":false,"latitude":"HgvYKSQ9Jcbfa0LB","longitude":"yV3j0A56zRwzZq2W","timer":12,"group_id":15}'
...
let body = {
    "name": "r9XxdKM7SdWQQZDy",
    "current_location_flag": false,
    "latitude": "HgvYKSQ9Jcbfa0LB",
    "longitude": "yV3j0A56zRwzZq2W",
    "timer": 12,
    "group_id": 15
}
    ...
    "data": {
        ...
        "group": {
            ...
            "users": [
                ...
                {
                    "id": 12,
                    "unique_id": "9z4bHpR1Kc",
                    "name": null,
                    "username": "佐藤 明美",
                    "email": "yamamoto.yuki@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:16:59.000000",
                ...
                {
                    "id": 28,
                    "unique_id": "IRAcAzlg3v",
                    "name": null,
                    "username": "杉山 千代",
                    "email": "rei55@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:17:00.000000",
                ...
                {
                    "id": 30,
                    "unique_id": "eTZMsi6AUL",
                    "name": null,
                    "username": "山本 明美",
                    "email": "hiroshi02@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:17:00.000000",
                ...
                {
                    "id": 31,
                    "unique_id": "IUDxy0VYcW",
                    "name": null,
                    "username": "中村 裕太",
                    "email": "haruka.nakatsugawa@example.com",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:17:00.000000",
        ...
        "created_at": {
            "date": "2019-02-27 15:18:22.000000",
            "timezone_type": 3,
            "timezone": "UTC"
        },
        "updated_at": {
...
const url = new URL("http://localhost/api/default_settings/{default_setting}");
    ...
    let params = {
            "default_setting": "U5YABjIPGOOFTLGD",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
curl -X PUT "http://localhost/api/default_settings/{default_setting}" \
    -H "Content-Type: application/json" \
    -d '{"name":"JtPsFIwbx5eagS3v","current_location_flag":false,"latitude":"V8KKQOEVqgjK6AmW","longitude":"MDx5rIb9qvqEf9lM","timer":15,"group_id":5}'
...
const url = new URL("http://localhost/api/default_settings/{default_setting}");
    ...
    let params = {
            "default_setting": "359feM1oluHJqRxD",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
let body = {
    "name": "JtPsFIwbx5eagS3v",
    "current_location_flag": false,
    "latitude": "V8KKQOEVqgjK6AmW",
    "longitude": "MDx5rIb9qvqEf9lM",
    "timer": 15,
    "group_id": 5
}
    ...
    "data": {
        ...
        "group": {
            ...
            "users": [
                {
                    "id": 14,
                    "unique_id": "LAzc0pSUqZ",
                    "name": null,
                    "username": "原田 太一",
                    "email": "kumiko.kijima@example.com",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:16:59.000000",
                ...
                {
                    "id": 18,
                    "unique_id": "Ou81rJ6Rwr",
                    "name": null,
                    "username": "中津川 里佳",
                    "email": "tsuda.mikako@example.org",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:17:00.000000",
                ...
                {
                    "id": 42,
                    "unique_id": "J31zEr3Kzy",
                    "name": null,
                    "username": "加藤 健一",
                    "email": "sato.manabu@example.org",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "created_at": {
                        "date": "2019-02-27 15:17:00.000000",
...
const url = new URL("http://localhost/api/default_settings/{default_setting}");
    ...
    let params = {
            "default_setting": "u8bMS9Te4ARIjWca",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
```json
{
    "data": [
        ...
        {
            "id": 11,
            "unique_id": "UGPOhuRBIa",
            "name": null,
            "username": "三宅 翼",
            "email": "rika65@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": null,
        ...
        {
            "id": 13,
            "unique_id": "V2iGyI26mh",
            "name": null,
            "username": "坂本 真綾",
            "email": "fkudo@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
        ...
        {
            "id": 24,
            "unique_id": "fJgTu0sIa7",
            "name": null,
            "username": "山田 翼",
            "email": "tomoya31@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
...
```json
{
    "data": [
        {
            "id": 9,
            "unique_id": "mJtuakSldc",
            "name": null,
            "username": "佐々木 零",
            "email": "taro.nomura@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
                ...
                "plus_minus": 1989,
                "created_at": {
                    "date": "2019-02-27 15:17:03.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -194,
                "created_at": {
                    "date": "2019-02-27 15:17:05.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 29,
            "unique_id": "T7dF29Z1Y7",
            "name": null,
            "username": "山本 七夏",
            "email": "yumiko.sakamoto@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
                ...
                "plus_minus": 1564,
                "created_at": {
                    "date": "2019-02-27 15:17:12.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": 87,
                "created_at": {
                    "date": "2019-02-27 15:17:13.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 37,
            "unique_id": "mt6bPZjOrS",
            "name": null,
            "username": "中村 あすか",
            "email": "kaori47@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
                ...
                "plus_minus": 117,
                "created_at": {
                    "date": "2019-02-27 15:17:16.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
...
```json
{
    "data": [
        {
            "id": 41,
            "unique_id": "ctC6IaL1H6",
            "name": null,
            "username": "斉藤 さゆり",
            "email": "hiroshi35@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 0,
            "attribute": {
...
```json
{
    "data": [
        {
            "id": 4,
            "unique_id": "1Xl8kM4nqL",
            "name": null,
            "username": "村山 翔太",
            "email": "usuzuki@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": null,
        ...
        {
            "id": 7,
            "unique_id": "YkkjK8Homu",
            "name": null,
            "username": "桐山 京助",
            "email": "fujimoto.kana@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 19,
            "unique_id": "Jwk5f0kBYR",
            "name": null,
            "username": "木村 舞",
            "email": "sasaki.akemi@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": {
        ...
        {
            "id": 38,
            "unique_id": "w3LdgMnbLp",
            "name": null,
            "username": "若松 太一",
            "email": "kanou.sayuri@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": null,
        ...
        {
            "id": 39,
            "unique_id": "nL54SdGKWW",
            "name": null,
            "username": "原田 花子",
            "email": "kumiko62@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": null,
            "attribute": null,
        ...
        },
        {
            ...
            "updated_at": {
                "date": "2019-02-27 15:17:23.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "deleted_at": null
...
```json
{
    "data": [
        {
            "id": 3,
            "unique_id": "zYVw1638yQ",
            "name": null,
            "username": "渚 明美",
            "email": "pmiyazawa@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": -614,
                "created_at": {
                    "date": "2019-02-27 15:17:01.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 10,
            "unique_id": "thdQQn52PE",
            "name": null,
            "username": "高橋 さゆり",
            "email": "skudo@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": 2478,
                "created_at": {
                    "date": "2019-02-27 15:17:04.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 15,
            "unique_id": "xhsGcjKGuj",
            "name": null,
            "username": "石田 直子",
            "email": "maaya12@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": -591,
                "created_at": {
                    "date": "2019-02-27 15:17:06.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -1792,
                "created_at": {
                    "date": "2019-02-27 15:17:07.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": 509,
                "created_at": {
                    "date": "2019-02-27 15:17:14.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 43,
            "unique_id": "ahk9sebJHv",
            "name": null,
            "username": "村山 香織",
            "email": "nuno@example.net",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": 2618,
                "created_at": {
                    "date": "2019-02-27 15:17:19.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        {
            "id": 44,
            "unique_id": "jVLVzr0LWK",
            "name": null,
            "username": "笹田 直子",
            "email": "osamu.suzuki@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
        ...
        {
            "id": 46,
            "unique_id": "c5U3jbolq3",
            "name": null,
            "username": "西之園 太一",
            "email": "momoko39@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "permitted": 1,
            "attribute": {
                ...
                "plus_minus": -2095,
                "created_at": {
                    "date": "2019-02-27 15:17:20.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -1528,
                "created_at": {
                    "date": "2019-02-27 15:17:21.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
    ...
    "data": [
        ...
        },
        {
            ...
            "attribute": {
                ...
                "plus_minus": -408,
                "created_at": {
                    "date": "2019-02-27 15:17:08.000000",
                    "timezone_type": 3,
                    "timezone": "UTC"
                },
                "updated_at": {
...
curl -X POST "http://localhost/api/device_token" \
    -H "Content-Type: application/json" \
    -d '{"device_token":"2PerVSBoVmShUH4n"}'
...
```json
{
    "data": {
        ...
        "device_token": "newTokenslqFbjQncf5CIUmdgOFL",
        "created_at": {
            "date": "2019-02-27 15:18:21.000000",
            "timezone_type": 3,
            "timezone": "UTC"
...
const url = new URL("http://localhost/api/groups/{group}/users/{user}");
    ...
    let params = {
            "group": "vHGtSK2zjbPdcKLq",
            "user": "nDoRePHvoFqBgVb6",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/groups/{group}/users/{user}");
    ...
    let params = {
            "group": "M513jSoDKJa3HMgO",
            "user": "R8phrW2yGGBijht1",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
```json
{
    "data": {
        ...
        "users": [],
        "created_at": {
            "date": "2019-02-27 15:18:23.000000",
            "timezone_type": 3,
            "timezone": "UTC"
        },
        "updated_at": {
    ...
    "data": [
        {
            ...
            "users": [
                ...
                {
                    "id": 36,
                    "unique_id": "yvDEB6XybD",
                    "name": null,
                    "username": "中津川 浩",
                    "email": "ykato@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "allow",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 15752,
            "actual": 8854,
            "start_time": "2019-02-22 15:17:01",
            "end_time": null,
            "unit_rounding": "100",
            "manager": {
                "id": 3,
        ...
        },
        {
            ...
            "budget": 3288,
            "actual": 17760,
            "start_time": "2019-02-22 15:17:04",
            "end_time": "2019-03-09 15:17:04",
            "unit_rounding": "100",
            "manager": {
                "id": 11,
                "unique_id": "UGPOhuRBIa",
        ...
        },
        {
            ...
            "budget": 1415,
            "actual": 41324,
            "start_time": "2019-03-04 15:17:04",
            "end_time": "2019-03-09 15:17:04",
            "unit_rounding": "100",
            "manager": {
                "id": 11,
            ...
            "users": [
                ...
                {
                    "id": 47,
                    "unique_id": "x1rIssQUIo",
                    "name": null,
                    "username": "青田 和也",
                    "email": "miki81@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "wait",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 3242,
            "actual": 17145,
            "start_time": "2019-02-22 15:17:06",
            "end_time": "2019-03-09 15:17:06",
            "unit_rounding": "100",
            "manager": {
                "id": 14,
                "unique_id": "LAzc0pSUqZ",
            ...
            "users": [
                ...
                {
                    "id": 25,
                    "unique_id": "kezUjMIqc3",
                    "name": null,
                    "username": "近藤 零",
                    "email": "asuka21@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "deny",
                    "paid": 0,
        ...
        },
        {
            ...
            "users": [
                ...
                {
                    "id": 8,
                    "unique_id": "SFmTyMIdOx",
                    "name": null,
                    "username": "青田 浩",
                    "email": "soutaro.yoshimoto@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "allow",
                    "paid": 1,
        ...
        },
        {
            ...
            "users": [
                ...
                {
                    "id": 26,
                    "unique_id": "bEo1vXEbPY",
                    "name": null,
                    "username": "佐々木 陽子",
                    "email": "kato.tsubasa@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "deny",
                    "paid": 0,
                ...
                {
                    "id": 27,
                    "unique_id": "BZx3hZIzSQ",
                    "name": null,
                    "username": "桐山 知実",
                    "email": "harada.tsubasa@example.org",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "allow",
                    "paid": 1,
        ...
        },
        {
            ...
            "budget": 10368,
            "actual": 3120,
            "start_time": "2019-02-22 15:17:08",
            "end_time": "2019-03-09 15:17:08",
            "unit_rounding": "100",
            "manager": {
                "id": 18,
                "unique_id": "Ou81rJ6Rwr",
        ...
        },
        {
            ...
            "users": [
                ...
                {
                    "id": 23,
                    "unique_id": "8ENdG0F4ay",
                    "name": null,
                    "username": "藤本 結衣",
                    "email": "harada.sayuri@example.com",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "wait",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 10340,
            "actual": 9837,
            "start_time": "2019-02-17 15:17:14",
            "end_time": "2019-02-22 15:17:14",
            "unit_rounding": "100",
            "manager": {
                "id": 32,
                "unique_id": "NogWHO9ghn",
            ...
            "users": [
                ...
                {
                    "id": 45,
                    "unique_id": "VbtBTafPYw",
                    "name": null,
                    "username": "青田 直子",
                    "email": "sayuri88@example.com",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "wait",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 23331,
            "actual": 25350,
            "start_time": "2019-02-22 15:17:14",
            "end_time": null,
            "unit_rounding": "100",
            "manager": {
                "id": 32,
        ...
        },
        {
            ...
            "users": [
                ...
                {
                    "id": 21,
                    "unique_id": "xt1aG0DsxY",
                    "name": null,
                    "username": "工藤 翼",
                    "email": "kanou.kana@example.org",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "wait",
                    "paid": 0,
            ...
            "created_at": {
                "date": "2019-02-27 15:17:17.000000",
                "timezone_type": 3,
                "timezone": "UTC"
            },
            "updated_at": {
        ...
        },
        {
            ...
            "budget": 3035,
            "actual": 47254,
            "start_time": "2019-02-22 15:17:19",
            "end_time": null,
            "unit_rounding": "100",
            "manager": {
                "id": 44,
        ...
        },
        {
            ...
            "budget": 14042,
            "actual": 7008,
            "start_time": "2019-03-04 15:17:20",
            "end_time": "2019-03-09 15:17:20",
            "unit_rounding": "100",
            "manager": {
                "id": 46,
                "unique_id": "c5U3jbolq3",
        ...
        },
        {
            ...
            "budget": 25331,
            "actual": 7349,
            "start_time": "2019-02-22 15:17:21",
            "end_time": "2019-03-09 15:17:21",
            "unit_rounding": "100",
            "manager": {
                "id": 48,
                "unique_id": "LFes87L4C9",
        ...
        },
        {
            ...
            "users": [
                ...
                {
                    "id": 16,
                    "unique_id": "ZNy5z2ckIO",
                    "name": null,
                    "username": "山岸 翔太",
                    "email": "kana87@example.net",
                    "unique_id_search_flag": 1,
                    "username_search_flag": 1,
                    "join_status": "wait",
                    "paid": 0,
        ...
        },
        {
            ...
            "budget": 27124,
            "actual": 18695,
            "start_time": "2019-02-22 15:17:22",
            "end_time": "2019-03-09 15:17:22",
            "unit_rounding": "100",
            "manager": {
                "id": 50,
                "unique_id": "2ZTHyqmW0j",
...
curl -X PUT "http://localhost/api/guest/sessions/{session}" \
    -H "Content-Type: application/json" \
    -d '{"join_status":"hh9ab7dey6MgquV9"}'
...
curl -X PUT "http://localhost/api/profile/update" \
    -H "Content-Type: application/json" \
    -d '{"unique_id":"w69w3Ojv2TNPdkFP","username":"vMW1v5QJiidTzQVG","password":"tLwSVrSMVawzBwtY","unique_id_search_flag":false,"username_search_flag":false}'
...
let body = {
    "unique_id": "w69w3Ojv2TNPdkFP",
    "username": "vMW1v5QJiidTzQVG",
    "password": "tLwSVrSMVawzBwtY",
...
```json
{
    "data": {
        ...
        "updated_at": {
            "date": "2019-02-27 15:18:24.000000",
            "timezone_type": 3,
            "timezone": "UTC"
        },
        "deleted_at": null
...
```json
{
    "data": [
        ...
        {
            "id": 35,
            "unique_id": "6XbwkGy1X9",
            "name": null,
            "username": "井上 太一",
            "email": "ywakamatsu@example.com",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "created_at": {
                "date": "2019-02-27 15:17:00.000000",
        ...
        {
            "id": 40,
            "unique_id": "inYEaqNIwz",
            "name": null,
            "username": "坂本 洋介",
            "email": "kenichi.sakamoto@example.org",
            "unique_id_search_flag": 1,
            "username_search_flag": 1,
            "created_at": {
                "date": "2019-02-27 15:17:00.000000",
        ...
        {
            "id": 55,
            "unique_id": "Zqc4cvJjTl",
            "name": null,
            "username": "aaaa",
            "email": "IPFxrU@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-27 15:18:22.000000",
        ...
        {
            "id": 56,
            "unique_id": "gtrpglfg4G",
            "name": null,
            "username": "aaaa",
            "email": "wSHk0tP@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-27 15:18:23.000000",
        ...
        {
            "id": 57,
            "unique_id": "2fHuqypaBX",
            "name": null,
            "username": "aaaa",
            "email": "lw786Cwy@new.com",
            "unique_id_search_flag": 0,
            "username_search_flag": 0,
            "created_at": {
                "date": "2019-02-27 15:18:23.000000",
...
curl -X POST "http://localhost/api/sessions/{session}/users" \
    -H "Content-Type: application/json" \
    -d '{"user_id":"VZZi7Lua5PaBrW5K","join_status":"wQPufjM5lrtEjSED","paid":1,"budget":10,"budget_actual":18}'
...
let body = {
    "user_id": "VZZi7Lua5PaBrW5K",
    "join_status": "wQPufjM5lrtEjSED",
    "paid": 1,
    "budget": 10,
    "budget_actual": 18
}
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "cL6BpQc24yqxB8OG",
            "user": "4Rmfu7Ve8zjImh2m",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
curl -X PUT "http://localhost/api/sessions/{session}/users/{user}" \
    -H "Content-Type: application/json" \
    -d '{"join_status":9,"paid":13,"plus_minus":7,"attribute_name":"UGrk6FoIBdvF1gzm","budget":12,"budget_actual":6}'
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "YVys40Bm1d07z0CB",
            "user": "OzlWFbj1ALEBlZOV",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
let body = {
    ...
    "paid": 13,
    "plus_minus": 7,
    "attribute_name": "UGrk6FoIBdvF1gzm",
    "budget": 12,
    "budget_actual": 6
}
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}");
    ...
    let params = {
            "session": "9rQmqWnhxAmAmyoY",
            "user": "cfyAkOJxrxPdl2CM",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/sessions/{session}/users/{user}/switch_paid");
    ...
    let params = {
            "session": "v2GQ9rnwIIQ3Ht6K",
            "user": "RDlol50zGs63wnGC",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
...
const url = new URL("http://localhost/api/sessions/{session}/groups/{group}");
    ...
    let params = {
            "session": "zqtbd9hJpXY87mKP",
            "group": "hokZrrTyvLToj45M",
        };
    Object.keys(params).forEach(key => url.searchParams.append(key, params[key]));
    ...
    "data": [
        {
            ...
            "budget": 7461,
            "actual": 43214,
            "start_time": "2019-03-04 15:17:00",
            "end_time": "2019-03-09 15:17:00",
            "unit_rounding": "100",
            "manager": {
                "id": 1,
                "unique_id": "TESTTEST",
        ...
        },
        {
            ...
            "budget": 24313,
            "actual": 14638,
            "start_time": "2019-02-22 15:17:00",
            "end_time": "2019-03-09 15:17:00",
            "unit_rounding": "100",
            "manager": {
                "id": 1,
...
curl -X POST "http://localhost/api/sessions" \
    -H "Content-Type: application/json" \
    -d '{"name":"YYZ9aiW4iVbXbfpr","shop_id":"zu3nHZPk6BiIerLC","budget":7,"actual":4,"unit_rounding":12,"start_time":"o0Y58jmFTvdIbjkB","end_time":"nYJSv5Kg7rdomNC1"}'
...
let body = {
    "name": "YYZ9aiW4iVbXbfpr",
    "shop_id": "zu3nHZPk6BiIerLC",
    "budget": 7,
    "actual": 4,
    "unit_rounding": 12,
    "start_time": "o0Y58jmFTvdIbjkB",
    "end_time": "nYJSv5Kg7rdomNC1"
}
...
--------- | ------- | ------- | ------- | -----------
    ...
    unit_rounding | integer |  optional  | 丸め単位（1, 10, 100, 1000, 10000）
...
curl -X PUT "http://localhost/api/sessions/{session}" \
    -H "Content-Type: application/json" \
    -d '{"name":"Vsa3gzD4HBPPIiA6","shop_id":19,"budget":11,"actual":5,"unit_rounding":2,"start_time":"P6wchz3hzfOUOr5F","end_time":"EBD3UwB9eKLo6dEp"}'
...
let body = {
    "name": "Vsa3gzD4HBPPIiA6",
    "shop_id": 19,
    "budget": 11,
    "actual": 5,
    "unit_rounding": 2,
    "start_time": "P6wchz3hzfOUOr5F",
    "end_time": "EBD3UwB9eKLo6dEp"
}
