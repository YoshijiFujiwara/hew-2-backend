...
class FriendController extends Controller
{
    ...
    /**
     * friends.waitingFriends 申請した中で,許可を待っているユーザー一覧
     *
    ...
    public function waitingFriends(Request $request)
    {
        ...
        if ($request->user()->waitingFriends()->exists()) {
